...
| **AvatarAttachment** ( type ) | Signature ```kotlin constructor(type: String = "") ``` Parameters type: String Which part of the avatar the entity is meant to represent (i.e. head, body, right_hand, left_controller) Returns [AvatarAttachment](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_avatarattachment) |
| --- | --- |
...
| **type** : String [Get][Set] | Which part of the avatar the entity is meant to represent (i.e. head, body, right_hand, left_controller) Signature ```kotlin var type: String ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> AvatarAttachment ``` |
...
| **typeData** : [StringAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_stringattributedata) [Get] | Signature ```kotlin val typeData: StringAttributeData ``` |
