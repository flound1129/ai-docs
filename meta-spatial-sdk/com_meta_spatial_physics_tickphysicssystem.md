...
System that advances the physics simulation.

## Signature

```kotlin
class TickPhysicsSystem(val physicsBridge: PhysicsBridge) : SystemBase
```

## Constructors

| **TickPhysicsSystem** ( physicsBridge ) | Signature ```kotlin constructor(physicsBridge: PhysicsBridge) ``` Parameters physicsBridge: [PhysicsBridge](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_physicsbridge) The PhysicsBridge required to access the physics engine. Returns [TickPhysicsSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_tickphysicssystem) |
| --- | --- |
...
| --- | --- |
| **physicsBridge** : [PhysicsBridge](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_physicsbridge) [Get] | The PhysicsBridge required to access the physics engine. Signature ```kotlin val physicsBridge: PhysicsBridge ``` |
