...
| **GLXF** ( uri ) | Signature ```kotlin constructor(uri: Uri) ``` Parameters uri: Uri Returns [GLXF](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_glxf) |
| --- | --- |
...
| **uri** : Uri [Get][Set] | The entity that represents the root of the GLXF scene. Signature ```kotlin var uri: Uri ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> GLXF ``` |
...
| **uriData** : [URIAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_uriattributedata) [Get] | Signature ```kotlin val uriData: URIAttributeData ``` |
| **uriId** [Get] | Signature ```kotlin val uriId: ``` |
