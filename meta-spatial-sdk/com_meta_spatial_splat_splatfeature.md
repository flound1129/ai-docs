...
```kotlin
class SplatFeature(val context: SpatialContext, val systemManager: SystemManager) : SpatialFeature
```

## Constructors

| **SplatFeature** ( context , systemManager ) | Signature ```kotlin constructor(context: SpatialContext, systemManager: SystemManager) ``` Parameters context: [SpatialContext](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_spatialcontext) systemManager: [SystemManager](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_systemmanager) Returns [SplatFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_splat_splatfeature) |
| --- | --- |
