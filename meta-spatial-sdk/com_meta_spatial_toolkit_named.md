...
A named component. This is a simple component that can be used to name the Entity. This is useful for debugging as the [DataModelInspectorFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_datamodelinspector_datamodelinspectorfeature) will display this.
...
| **Named** ( name ) | Signature ```kotlin constructor(name: String = "n/a") ``` Parameters name: String The name of the Entity. Returns [Named](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_named) |
| --- | --- |
...
| **name** : String [Get][Set] | Signature ```kotlin var name: String ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Named ``` |
...
| **nameData** : [StringAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_stringattributedata) [Get] | Signature ```kotlin val nameData: StringAttributeData ``` |
| **nameId** [Get] | Signature ```kotlin val nameId: ``` |
