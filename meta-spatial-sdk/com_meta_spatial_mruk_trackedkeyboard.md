...
```kotlin
class TrackedKeyboard(anchorHandle: Long = 0) : ComponentBase
```

## Constructors

| **TrackedKeyboard** ( anchorHandle ) | Signature ```kotlin constructor(anchorHandle: Long = 0) ``` Parameters anchorHandle: Long Returns [TrackedKeyboard](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_trackedkeyboard) |
| --- | --- |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> TrackedKeyboard ``` |
