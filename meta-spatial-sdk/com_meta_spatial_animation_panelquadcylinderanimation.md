# PanelQuadCylinderAnimation Class
...
```kotlin
class PanelQuadCylinderAnimation(animationType: PanelQuadCylinderAnimationType = PanelQuadCylinderAnimationType.QUAD_TO_CYLINDER, initialRadius: Float = 0.0f, targetRadius: Float = 0.0f, startTime: Long = 0, durationInMs: Long = 500) : ComponentBase
```

## Constructors

| **PanelQuadCylinderAnimation** ( animationType , initialRadius , targetRadius , startTime , durationInMs ) | Signature ```kotlin constructor(animationType: PanelQuadCylinderAnimationType = PanelQuadCylinderAnimationType.QUAD_TO_CYLINDER, initialRadius: Float = 0.0f, targetRadius: Float = 0.0f, startTime: Long = 0, durationInMs: Long = 500) ``` Parameters animationType: [PanelQuadCylinderAnimationType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelquadcylinderanimationtype) initialRadius: Float targetRadius: Float startTime: Long durationInMs: Long Returns [PanelQuadCylinderAnimation](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelquadcylinderanimation) |
| --- | --- |

## Properties

| **animationType** : [PanelQuadCylinderAnimationType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelquadcylinderanimationtype) [Get][Set] | Signature ```kotlin var animationType: PanelQuadCylinderAnimationType ``` |
| --- | --- |
...
| **durationInMs** : Long [Get][Set] | Signature ```kotlin var durationInMs: Long ``` |
...
| **startTime** : Long [Get][Set] | Signature ```kotlin var startTime: Long ``` |
...
| **animationTypeData** : [EnumAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_enumattributedata) [Get] | Signature ```kotlin val animationTypeData: EnumAttributeData ``` |
| --- | --- |
| **animationTypeId** [Get] | Signature ```kotlin val animationTypeId: ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> PanelQuadCylinderAnimation ``` |
| **durationInMsData** : [LongAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_longattributedata) [Get] | Signature ```kotlin val durationInMsData: LongAttributeData ``` |
| **durationInMsId** [Get] | Signature ```kotlin val durationInMsId: ``` |
...
| **initialRadiusData** : [FloatAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_floatattributedata) [Get] | Signature ```kotlin val initialRadiusData: FloatAttributeData ``` |
| **initialRadiusId** [Get] | Signature ```kotlin val initialRadiusId: ``` |
| **keyStringToKeyIntMap_** : Map [Get] | Signature ```kotlin val keyStringToKeyIntMap_: Map<String, Int> ``` |
| **startTimeData** : [TimeAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_timeattributedata) [Get] | Signature ```kotlin val startTimeData: TimeAttributeData ``` |
| **startTimeId** [Get] | Signature ```kotlin val startTimeId: ``` |
| **targetRadiusData** : [FloatAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_floatattributedata) [Get] | Signature ```kotlin val targetRadiusData: FloatAttributeData ``` |
| **targetRadiusId** [Get] | Signature ```kotlin val targetRadiusId: ``` |
