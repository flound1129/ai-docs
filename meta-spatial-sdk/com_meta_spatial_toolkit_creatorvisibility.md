...
| **CreatorVisibility** ( state ) | Signature ```kotlin constructor(state: CreatorVisibilityState = CreatorVisibilityState.CREATOR_ONLY_VISIBLE) ``` Parameters state: [CreatorVisibilityState](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_creatorvisibilitystate) The state of the visibility, see CreatorVisibilityState for more info Returns [CreatorVisibility](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_creatorvisibility) |
| --- | --- |
...
| **state** : [CreatorVisibilityState](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_creatorvisibilitystate) [Get][Set] | Different states of CreatorVisibility, such as only visible to the creator, or only invisible to the creator Signature ```kotlin var state: CreatorVisibilityState ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> CreatorVisibility ``` |
