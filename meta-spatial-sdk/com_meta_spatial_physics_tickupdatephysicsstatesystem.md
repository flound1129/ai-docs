# TickUpdatePhysicsStateSystem Class
...
System that synchronizes physics state of entities with the physics engine.

## Signature

```kotlin
class TickUpdatePhysicsStateSystem(val physicsBridge: PhysicsBridge) : SystemBase
```

## Constructors

| **TickUpdatePhysicsStateSystem** ( physicsBridge ) | Signature ```kotlin constructor(physicsBridge: PhysicsBridge) ``` Parameters physicsBridge: [PhysicsBridge](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_physicsbridge) The PhysicsBridge used to update physics state Returns [TickUpdatePhysicsStateSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_tickupdatephysicsstatesystem) |
| --- | --- |
...
| --- | --- |
| **physicsBridge** : [PhysicsBridge](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_physicsbridge) [Get] | The PhysicsBridge used to update physics state Signature ```kotlin val physicsBridge: PhysicsBridge ``` |
