...
Use [ComponentRegistrations.all](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_componentregistrations#all) to get all component registrations for use with [SpatialFeature.componentsToRegister](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_spatialfeature#componentstoregister) .
