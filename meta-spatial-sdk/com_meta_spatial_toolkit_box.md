...
Defines the dimensions of a box shape by the relative offset of two opposite corners. This is to be used with the `mesh://box` URI on [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) component. Material can be customized with the [Material](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_material) component.

Example:

```kotlin Entity.create(
        listOf(
            Mesh(Box.URI), // Applying box mesh
            Material().apply { // Applying Material Component for procdeurally generated mesh.
              baseColor = Color4(red = 1.0f, green = 0.1f, blue = 0.1f, alpha = 1.0f)
            },
            Box(Vector3(-0.25f, -0.25f, -0.25f), Vector3(0.25f, 0.25f, 0.25f)), // Modifying Box dimension with component
...
| **Box** ( min , max ) | Signature ```kotlin constructor(min: Vector3 = Vector3(0.0f, 0.0f, 0.0f), max: Vector3 = Vector3(0.0f, 0.0f, 0.0f)) ``` Parameters min: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) The relative offset in meters of the bottom corner (furthest in the -x, -y, -z direction) max: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) The relative offset in meters of the top corner (furthest in the +x, +y, +z direction) Returns [Box](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_box) |
| --- | --- |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Box ``` |
...
| **URI** : Uri [Get] | URI for the procedural box mesh. Use with [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) component. Signature ```kotlin val URI: Uri ``` |
