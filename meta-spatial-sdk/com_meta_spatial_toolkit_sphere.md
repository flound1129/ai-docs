...
Defines the dimensions of a sphere by specifying its radius. This is to be used with the `mesh://sphere` URI on [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) component. Material can be customized with the [Material](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_material) component.

Spheres are commonly used for balls, planets, or any rounded object in 3D scenes.
...
| **Sphere** ( radius ) | Signature ```kotlin constructor(radius: Float = 0.5f) ``` Parameters radius: Float The radius of the sphere in meters Returns [Sphere](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_sphere) |
| --- | --- |
...
| **radius** : Float [Get][Set] | The radius of the sphere in meters Signature ```kotlin var radius: Float ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Sphere ``` |
...
| **URI** : Uri [Get] | URI for the procedural sphere mesh. Use with [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) component. Signature ```kotlin val URI: Uri ``` |
