...
Auto-generated component registrations for com.meta.spatial.spatialaudio.

Use [ComponentRegistrations.all](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_componentregistrations#all) to get all component registrations for use with [SpatialFeature.componentsToRegister](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_spatialfeature#componentstoregister) .
