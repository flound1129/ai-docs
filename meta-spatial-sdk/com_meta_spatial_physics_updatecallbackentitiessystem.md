# UpdateCallbackEntitiesSystem Class
...
System that updates the list of entities that have collision callbacks.
...
| **UpdateCallbackEntitiesSystem** ( mScene ) | Signature ```kotlin constructor(mScene: Long) ``` Parameters mScene: Long The native scene handle pointer Returns [UpdateCallbackEntitiesSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_physics_updatecallbackentitiessystem) |
| --- | --- |
...
| --- | --- |
| **mScene** : Long [Get] | The native scene handle pointer Signature ```kotlin val mScene: Long ``` |
