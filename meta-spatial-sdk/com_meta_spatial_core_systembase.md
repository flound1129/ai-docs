...
Systems are responsible for performing operations on entities in the scene.
...
| **SystemBase** () | Signature ```kotlin constructor() ``` Returns [SystemBase](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_systembase) |
| --- | --- |
