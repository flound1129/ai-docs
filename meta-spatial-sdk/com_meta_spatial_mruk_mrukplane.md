...
```kotlin
class MRUKPlane(min: Vector2 = Vector2(0.0f, 0.0f), max: Vector2 = Vector2(0.0f, 0.0f), boundariesCount: Int = 0) : ComponentBase
```

## Constructors

| **MRUKPlane** ( min , max , boundary ) | Signature ```kotlin constructor(min: Vector2, max: Vector2, boundary: HashMap<Int, Vector2>, Vector2> = hashMapOf()) ``` Parameters min: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) max: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) boundary: HashMap<Int, Vector2> Returns [MRUKPlane](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_mrukplane) |
| --- | --- |
| **MRUKPlane** ( min , max , boundariesCount ) | Signature ```kotlin constructor(min: Vector2 = Vector2(0.0f, 0.0f), max: Vector2 = Vector2(0.0f, 0.0f), boundariesCount: Int = 0) ``` Parameters min: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) max: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) boundariesCount: Int Returns [MRUKPlane](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_mrukplane) |

## Properties

| **boundariesCount** : Int [Get][Set] | Signature ```kotlin var boundariesCount: Int ``` |
| --- | --- |
| **boundary** : MapDelegate [Get][Set] | Signature ```kotlin var boundary: MapDelegate<Int, Vector2> ``` |
...
| **max** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | Signature ```kotlin var max: Vector2 ``` |
| **min** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | Signature ```kotlin var min: Vector2 ``` |
...
| --- | --- |
| **getBoundaryAsList** () | Signature ```kotlin fun MRUKPlane.getBoundaryAsList(): List<Vector2> ``` Returns List |
| **getCenter** () | Signature ```kotlin fun MRUKPlane.getCenter(): Vector2 ``` Returns [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) |
...
| **getSize** () | Signature ```kotlin fun MRUKPlane.getSize(): Vector2 ``` Returns [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) |
...
| **isPositionInBoundary** ( position ) | Signature ```kotlin fun MRUKPlane.isPositionInBoundary(position: Vector2): Boolean ``` Parameters position: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) Returns Boolean |
...
| **size** () | Signature ```kotlin fun MRUKPlane.size(): Vector2 ``` Returns [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) |
...
| **boundariesCountData** : [IntAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_intattributedata) [Get] | Signature ```kotlin val boundariesCountData: IntAttributeData ``` |
| **boundariesCountId** [Get] | Signature ```kotlin val boundariesCountId: ``` |
| **boundaryData** : [ExperimentalMapAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_experimentalmapattributedata) [Get] | Signature ```kotlin val boundaryData: ExperimentalMapAttributeData<Int, Vector2> ``` |
| **boundaryId** [Get] | Signature ```kotlin val boundaryId: ``` |
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> MRUKPlane ``` |
...
| **maxData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val maxData: Vector2AttributeData ``` |
| **maxId** [Get] | Signature ```kotlin val maxId: ``` |
| **minData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val minData: Vector2AttributeData ``` |
