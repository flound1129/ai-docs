...
| **GLXFRoot** ( rootEntity ) | Signature ```kotlin constructor(rootEntity: Entity = Entity.nullEntity()) ``` Parameters rootEntity: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) Returns [GLXFRoot](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_glxfroot) |
| --- | --- |
...
| **rootEntity** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The root entity of the glXF that this entity was inflated with. Signature ```kotlin var rootEntity: Entity ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> GLXFRoot ``` |
...
| **rootEntityData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val rootEntityData: EntityAttributeData ``` |
| **rootEntityId** [Get] | Signature ```kotlin val rootEntityId: ``` |
