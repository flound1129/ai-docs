...
This System comes default with Meta Spatial SDK and processes listeners in the [DataModel](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_datamodel) .
...
| **ProcessListenersSystem** ( spatial ) | Signature ```kotlin constructor(spatial: SpatialInterface) ``` Parameters spatial: [SpatialInterface](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_spatialinterface) Returns [ProcessListenersSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_processlistenerssystem) |
| --- | --- |
