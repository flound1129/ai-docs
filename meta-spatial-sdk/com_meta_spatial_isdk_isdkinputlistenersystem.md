...
| **IsdkInputListenerSystem** () | Signature ```kotlin constructor() ``` Returns [IsdkInputListenerSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkinputlistenersystem) |
| --- | --- |
...
| **setInputListener** ( inputListener ) | Signature ```kotlin fun setInputListener(inputListener: InputListener) ``` Parameters inputListener: [InputListener](/reference/spatial-sdk/v0.10.1/com_meta_spatial_runtime_inputlistener) |