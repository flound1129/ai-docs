...
Use in combination with AudioSessionId to customize the orientation of the soundfield (should only be used when AudioSessionId.type == AudioType.SOUNDFIELD).

## Signature

```kotlin
class SoundfieldOrientation(type: SoundfieldOrientationType = SoundfieldOrientationType.POSITION) : ComponentBase
```

## Constructors

| **SoundfieldOrientation** ( type ) | Signature ```kotlin constructor(type: SoundfieldOrientationType = SoundfieldOrientationType.POSITION) ``` Parameters type: [SoundfieldOrientationType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_soundfieldorientationtype) Returns [SoundfieldOrientation](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_soundfieldorientation) |
| --- | --- |
...
| **type** : [SoundfieldOrientationType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_soundfieldorientationtype) [Get][Set] | Signature ```kotlin var type: SoundfieldOrientationType ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> SoundfieldOrientation ``` |
