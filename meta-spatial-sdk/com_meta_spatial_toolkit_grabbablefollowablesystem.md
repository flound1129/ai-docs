# GrabbableFollowableSystem Class
...
```kotlin
class GrabbableFollowableSystem : SystemBase
```

## Constructors

| **GrabbableFollowableSystem** () | Signature ```kotlin constructor() ``` Returns [GrabbableFollowableSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_grabbablefollowablesystem) |
| --- | --- |
