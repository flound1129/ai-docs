...
IsdkGrabFilter allows filtering of grabbable interactions based on the type of grab interactor.     This component can be used to control which grab interactions are valid for this entity.

```kotlin @param handContactPinch Whether hand contact pinch grab interactions are allowed
@param handDistancePinch Whether hand distance pinch grab interactions are allowed
@param handContactPalm Whether hand contact palm grab interactions are allowed
@param handDistancePalm Whether hand distance palm grab interactions are allowed ```

## Signature

```kotlin
class IsdkGrabFilter(handContactPinch: Boolean = true, handDistancePinch: Boolean = true, handContactPalm: Boolean = true, handDistancePalm: Boolean = false) : ComponentBase
```

## Constructors

| **IsdkGrabFilter** ( handContactPinch , handDistancePinch , handContactPalm , handDistancePalm ) | Signature ```kotlin constructor(handContactPinch: Boolean = true, handDistancePinch: Boolean = true, handContactPalm: Boolean = true, handDistancePalm: Boolean = false) ``` Parameters handContactPinch: Boolean handDistancePinch: Boolean handContactPalm: Boolean handDistancePalm: Boolean Returns [IsdkGrabFilter](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkgrabfilter) |
| --- | --- |
...
| **handContactPalm** : Boolean [Get][Set] | Whether hand contact palm grab interactions are allowed Signature ```kotlin var handContactPalm: Boolean ``` |
| **handContactPinch** : Boolean [Get][Set] | Whether hand contact pinch grab interactions are allowed Signature ```kotlin var handContactPinch: Boolean ``` |
| **handDistancePalm** : Boolean [Get][Set] | Whether hand distance palm grab interactions are allowed Signature ```kotlin var handDistancePalm: Boolean ``` |
| **handDistancePinch** : Boolean [Get][Set] | Whether hand distance pinch grab interactions are allowed Signature ```kotlin var handDistancePinch: Boolean ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> IsdkGrabFilter ``` |
| **enumClassesMap_** : Map [Get] | Signature ```kotlin val enumClassesMap_: Map<Int, Class<out Enum<*>>> ``` |
| **handContactPalmData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val handContactPalmData: BooleanAttributeData ``` |
| **handContactPalmId** [Get] | Signature ```kotlin val handContactPalmId: ``` |
| **handContactPinchData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val handContactPinchData: BooleanAttributeData ``` |
| **handContactPinchId** [Get] | Signature ```kotlin val handContactPinchId: ``` |
| **handDistancePalmData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val handDistancePalmData: BooleanAttributeData ``` |
| **handDistancePalmId** [Get] | Signature ```kotlin val handDistancePalmId: ``` |
| **handDistancePinchData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val handDistancePinchData: BooleanAttributeData ``` |
| **handDistancePinchId** [Get] | Signature ```kotlin val handDistancePinchId: ``` |
