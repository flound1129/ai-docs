...
| **Audio** ( audio , volume ) | Signature ```kotlin constructor(audio: String = "", volume: Float = 1.0f) ``` Parameters audio: String volume: Float The volume of the audio to be played, default is 1.0f Returns [Audio](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_audio) |
| --- | --- |

## Properties

| **audio** : String [Get][Set] | The Uri String of the audio file to be used Signature ```kotlin var audio: String ``` |
| --- | --- |
...
| **volume** : Float [Get][Set] | Signature ```kotlin var volume: Float ``` |
...
| **audioData** : [StringAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_stringattributedata) [Get] | Signature ```kotlin val audioData: StringAttributeData ``` |
| **audioId** [Get] | Signature ```kotlin val audioId: ``` |
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Audio ``` |
...
| **volumeData** : [FloatAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_floatattributedata) [Get] | Signature ```kotlin val volumeData: FloatAttributeData ``` |
| **volumeId** [Get] | Signature ```kotlin val volumeId: ``` |
