...
The AnchorProcMeshInfo contains the information required to generate a procedural mesh. It's intended for internal use only.

## Signature

```kotlin
class AnchorProcMeshInfo(cutHoleLabels: String = "", planeUvOffset: Vector2 = Vector2(0.0f, 0.0f), planeUvScale: Vector2 = Vector2(1.0f, 1.0f)) : ComponentBase
```

## Constructors

| **AnchorProcMeshInfo** ( cutHoleLabels , planeUv ) | Signature ```kotlin constructor(cutHoleLabels: List<MRUKLabel> = listOf(), planeUv: MRUKPlaneUV = MRUKPlaneUV(Vector2(0.0f, 0.0f), Vector2(1.0f, 1.0f))) ``` Parameters cutHoleLabels: List planeUv: [MRUKPlaneUV](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_mrukplaneuv) Returns [AnchorProcMeshInfo](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_anchorprocmeshinfo) |
| --- | --- |
| **AnchorProcMeshInfo** ( cutHoleLabels , planeUvOffset , planeUvScale ) | Signature ```kotlin constructor(cutHoleLabels: String = "", planeUvOffset: Vector2 = Vector2(0.0f, 0.0f), planeUvScale: Vector2 = Vector2(1.0f, 1.0f)) ``` Parameters cutHoleLabels: String planeUvOffset: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) planeUvScale: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) Returns [AnchorProcMeshInfo](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_anchorprocmeshinfo) |
...
| --- | --- |
| **cutHoleLabels** : String [Get][Set] | Signature ```kotlin var cutHoleLabels: String ``` |
| **entID** : Long [Get][Set] | Signature ```kotlin var entID: Long ``` |
| **isDirty** : Boolean [Get][Set] | Signature ```kotlin var isDirty: Boolean ``` |
| **planeUvOffset** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | Signature ```kotlin var planeUvOffset: Vector2 ``` |
| **planeUvScale** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | Signature ```kotlin var planeUvScale: Vector2 ``` |
...
| **getCutHoleLabelsAsList** () | Signature ```kotlin fun AnchorProcMeshInfo.getCutHoleLabelsAsList(): List<MRUKLabel> ``` Returns List |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> AnchorProcMeshInfo ``` |
| **cutHoleLabelsData** : [StringAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_stringattributedata) [Get] | Signature ```kotlin val cutHoleLabelsData: StringAttributeData ``` |
| **cutHoleLabelsId** [Get] | Signature ```kotlin val cutHoleLabelsId: ``` |
...
| **planeUvOffsetData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val planeUvOffsetData: Vector2AttributeData ``` |
| **planeUvOffsetId** [Get] | Signature ```kotlin val planeUvOffsetId: ``` |
| **planeUvScaleData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val planeUvScaleData: Vector2AttributeData ``` |
| **planeUvScaleId** [Get] | Signature ```kotlin val planeUvScaleId: ``` |
