...
This System comes default with Meta Spatial SDK and operates on entities that have been marked for deletion in the [DataModel](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_datamodel) . It interacts with [SceneObjectSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_sceneobjectsystem) to clean up associated [SceneObject](/reference/spatial-sdk/v0.10.1/com_meta_spatial_runtime_sceneobject) s.
...
| **DeleteEntitiesSystem** () | Signature ```kotlin constructor() ``` Returns [DeleteEntitiesSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_deleteentitiessystem) |
| --- | --- |
