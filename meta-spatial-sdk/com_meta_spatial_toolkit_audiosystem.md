...
This System comes default with Meta Spatial SDK and operates on entities with [Audio](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_audio) components. It interacts with [Transform](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_transform) components to position audio sources in 3D space.
...
| **AudioSystem** () | Signature ```kotlin constructor() ``` Returns [AudioSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_audiosystem) |
| --- | --- |
...
| --- | --- |
| **delete** ( entity ) | System should do any housekeeping based on [AudioSystem.delete](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_audiosystem#delete) being removed from the scene Signature ```kotlin open override fun delete(entity: Entity) ``` Parameters entity: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) |
