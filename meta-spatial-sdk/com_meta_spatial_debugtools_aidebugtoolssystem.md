...
```kotlin
class AIDebugToolsSystem(activity: AppSystemActivity) : SystemBase
```

## Constructors

| **AIDebugToolsSystem** ( activity ) | Signature ```kotlin constructor(activity: AppSystemActivity) ``` Parameters activity: [AppSystemActivity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_appsystemactivity) Returns [AIDebugToolsSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_debugtools_aidebugtoolssystem) |
| --- | --- |
...
| **getSceneSnapshot** () | Signature ```kotlin fun getSceneSnapshot(): JSONObject ``` Returns JSONObject |
