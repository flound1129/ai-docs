...
```kotlin
class TrackedQrCode(anchorHandle: Long = 0, payloadType: MarkerPayloadType = MarkerPayloadType.InvalidQrCode, payload: String = "") : ComponentBase
```

## Constructors

| **TrackedQrCode** ( anchorHandle , payloadType , payload ) | Signature ```kotlin constructor(anchorHandle: Long, payloadType: MarkerPayloadType, payload: ByteArray) ``` Parameters anchorHandle: Long payloadType: [MarkerPayloadType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_markerpayloadtype) payload: ByteArray Returns [TrackedQrCode](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_trackedqrcode) |
| --- | --- |
| **TrackedQrCode** ( anchorHandle , payloadType , payload ) | Signature ```kotlin constructor(anchorHandle: Long = 0, payloadType: MarkerPayloadType = MarkerPayloadType.InvalidQrCode, payload: String = "") ``` Parameters anchorHandle: Long payloadType: [MarkerPayloadType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_markerpayloadtype) payload: String Returns [TrackedQrCode](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_trackedqrcode) |

## Properties

| **anchorHandle** : Long [Get][Set] | Signature ```kotlin var anchorHandle: Long ``` |
| --- | --- |
...
| **payload** : String [Get][Set] | Signature ```kotlin var payload: String ``` |
| **payloadType** : [MarkerPayloadType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_markerpayloadtype) [Get][Set] | Signature ```kotlin var payloadType: MarkerPayloadType ``` |
...
| **getPayloadAsString** () | Signature ```kotlin fun TrackedQrCode.getPayloadAsString(): String ``` Returns String |
...
| **anchorHandleData** : [LongAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_longattributedata) [Get] | Signature ```kotlin val anchorHandleData: LongAttributeData ``` |
| --- | --- |
| **anchorHandleId** [Get] | Signature ```kotlin val anchorHandleId: ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> TrackedQrCode ``` |
...
| **payloadData** : [StringAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_stringattributedata) [Get] | Signature ```kotlin val payloadData: StringAttributeData ``` |
| **payloadId** [Get] | Signature ```kotlin val payloadId: ``` |
| **payloadTypeData** : [EnumAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_enumattributedata) [Get] | Signature ```kotlin val payloadTypeData: EnumAttributeData ``` |
| **payloadTypeId** [Get] | Signature ```kotlin val payloadTypeId: ``` |
