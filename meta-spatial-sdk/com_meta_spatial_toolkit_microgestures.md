...
Stores the state of microgestures, as well as which microgestures have changed since the last frame.

## Signature

```kotlin
class Microgestures(microgestureState: Int = 0, changedMicrogestures: Int = 0) : ComponentBase
```

## Constructors

| **Microgestures** ( microgestureState , changedMicrogestures ) | Signature ```kotlin constructor(microgestureState: Int = 0, changedMicrogestures: Int = 0) ``` Parameters microgestureState: Int The current state of microgestures being detected, represented by integer bits changedMicrogestures: Int Which microgestures (represented by integer bits) have changed states (detected or undetected) Returns [Microgestures](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_microgestures) |
| --- | --- |
...
| --- | --- |
| **changedMicrogestures** : Int [Get][Set] | Which microgestures (represented by integer bits) have changed states (detected or undetected) Signature ```kotlin var changedMicrogestures: Int ``` |
| **entID** : Long [Get][Set] | Signature ```kotlin var entID: Long ``` |
| **isDirty** : Boolean [Get][Set] | Signature ```kotlin var isDirty: Boolean ``` |
| **microgestureState** : Int [Get][Set] | The current state of microgestures being detected, represented by integer bits Signature ```kotlin var microgestureState: Int ``` |
...
| **changedMicrogesturesData** : [IntAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_intattributedata) [Get] | Signature ```kotlin val changedMicrogesturesData: IntAttributeData ``` |
| **changedMicrogesturesId** [Get] | Signature ```kotlin val changedMicrogesturesId: ``` |
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Microgestures ``` |
...
| **microgestureStateData** : [IntAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_intattributedata) [Get] | Signature ```kotlin val microgestureStateData: IntAttributeData ``` |
| **microgestureStateId** [Get] | Signature ```kotlin val microgestureStateId: ``` |
