...
| **AvatarBody** ( head , leftHand , rightHand , root , isPlayerControlled ) | Signature ```kotlin constructor(head: Entity = Entity.nullEntity(), leftHand: Entity = Entity.nullEntity(), rightHand: Entity = Entity.nullEntity(), root: Entity = Entity.nullEntity(), isPlayerControlled: Boolean = false) ``` Parameters head: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) The head Entity of the avatar. leftHand: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) The left hand Entity of the avatar. rightHand: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) The right hand Entity of the avatar. root: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) The root Entity of the avatar. isPlayerControlled: Boolean A boolean flag to indicate whether the avatar is player controlled. Returns [AvatarBody](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_avatarbody) |
| --- | --- |
...
| **head** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The head Entity of the avatar. Signature ```kotlin var head: Entity ``` |
| **isDirty** : Boolean [Get][Set] | Signature ```kotlin var isDirty: Boolean ``` |
| **isPlayerControlled** : Boolean [Get][Set] | A boolean flag to indicate whether the avatar is player controlled. Signature ```kotlin var isPlayerControlled: Boolean ``` |
| **leftHand** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The left hand Entity of the avatar. Signature ```kotlin var leftHand: Entity ``` |
| **recycled** : Boolean [Get][Set] | Signature ```kotlin var recycled: Boolean ``` |
| **rightHand** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The right hand Entity of the avatar. Signature ```kotlin var rightHand: Entity ``` |
| **root** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The root Entity of the avatar. Signature ```kotlin var root: Entity ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> AvatarBody ``` |
| **enumClassesMap_** : Map [Get] | Signature ```kotlin val enumClassesMap_: Map<Int, Class<out Enum<*>>> ``` |
| **headData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val headData: EntityAttributeData ``` |
| **headId** [Get] | Signature ```kotlin val headId: ``` |
| **id** [Get] | Signature ```kotlin open override val id: ``` |
| **isPlayerControlledData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val isPlayerControlledData: BooleanAttributeData ``` |
| **isPlayerControlledId** [Get] | Signature ```kotlin val isPlayerControlledId: ``` |
| **keyStringToKeyIntMap_** : Map [Get] | Signature ```kotlin val keyStringToKeyIntMap_: Map<String, Int> ``` |
| **leftHandData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val leftHandData: EntityAttributeData ``` |
| **leftHandId** [Get] | Signature ```kotlin val leftHandId: ``` |
| **rightHandData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val rightHandData: EntityAttributeData ``` |
| **rightHandId** [Get] | Signature ```kotlin val rightHandId: ``` |
| **rootData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val rootData: EntityAttributeData ``` |
| **rootId** [Get] | Signature ```kotlin val rootId: ``` |
