# AudioSessionStereoOffsets Class
...
Stereo Offsets for an AudioSessionId

## Signature

```kotlin
class AudioSessionStereoOffsets(left: Vector3 = Vector3(0.0f, 0.0f, 0.0f), right: Vector3 = Vector3(0.0f, 0.0f, 0.0f), mode: StereoOffsetMode = StereoOffsetMode.LOCAL_SPACE) : ComponentBase
```

## Constructors

| **AudioSessionStereoOffsets** ( left , right , mode ) | Signature ```kotlin constructor(left: Vector3 = Vector3(0.0f, 0.0f, 0.0f), right: Vector3 = Vector3(0.0f, 0.0f, 0.0f), mode: StereoOffsetMode = StereoOffsetMode.LOCAL_SPACE) ``` Parameters left: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) right: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) mode: [StereoOffsetMode](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_stereooffsetmode) Returns [AudioSessionStereoOffsets](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_audiosessionstereooffsets) |
| --- | --- |
...
| **left** : [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) [Get][Set] | Signature ```kotlin var left: Vector3 ``` |
| **mode** : [StereoOffsetMode](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_stereooffsetmode) [Get][Set] | Signature ```kotlin var mode: StereoOffsetMode ``` |
| **recycled** : Boolean [Get][Set] | Signature ```kotlin var recycled: Boolean ``` |
| **right** : [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) [Get][Set] | Signature ```kotlin var right: Vector3 ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> AudioSessionStereoOffsets ``` |
...
| **leftData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val leftData: Vector3AttributeData ``` |
| **leftId** [Get] | Signature ```kotlin val leftId: ``` |
| **modeData** : [EnumAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_enumattributedata) [Get] | Signature ```kotlin val modeData: EnumAttributeData ``` |
| **modeId** [Get] | Signature ```kotlin val modeId: ``` |
| **rightData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val rightData: Vector3AttributeData ``` |
| **rightId** [Get] | Signature ```kotlin val rightId: ``` |
