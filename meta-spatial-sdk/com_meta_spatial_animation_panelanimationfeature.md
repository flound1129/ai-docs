...
```kotlin
class PanelAnimationFeature : SpatialFeature
```

## Constructors

| **PanelAnimationFeature** () | Signature ```kotlin constructor() ``` Returns [PanelAnimationFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelanimationfeature) |
| --- | --- |
