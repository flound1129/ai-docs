...
```kotlin
class PanelAnimationSystem : SystemBase
```

## Constructors

| **PanelAnimationSystem** () | Signature ```kotlin constructor() ``` Returns [PanelAnimationSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelanimationsystem) |
| --- | --- |
...
| --- | --- |
| **panelQuadCylinderLocalStates** : MutableMap [Get] | Signature ```kotlin val panelQuadCylinderLocalStates: MutableMap<Entity, PanelQuadCylinderLocalState> ``` |
| **panelScaleInLocalStates** : MutableMap [Get] | Signature ```kotlin val panelScaleInLocalStates: MutableMap<Entity, PanelScaleInLocalState> ``` |
| **panelScaleOutLocalStates** : MutableMap [Get] | Signature ```kotlin val panelScaleOutLocalStates: MutableMap<Entity, PanelScaleOutLocalState> ``` |
