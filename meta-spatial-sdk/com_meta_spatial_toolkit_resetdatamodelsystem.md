...
This System comes default with Meta Spatial SDK and is "resets" the [DataModel](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_datamodel) every tick. The Data Model reset is responsible for collecting changes and making them accessible via the "changed" [Query](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_query) .
...
| **ResetDataModelSystem** ( spatial ) | Signature ```kotlin constructor(spatial: SpatialInterface) ``` Parameters spatial: [SpatialInterface](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_spatialinterface) Returns [ResetDataModelSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_resetdatamodelsystem) |
| --- | --- |
