...
```kotlin
class TrackingStatus(isTracked: Boolean = false) : ComponentBase
```

## Constructors

| **TrackingStatus** ( isTracked ) | Signature ```kotlin constructor(isTracked: Boolean = false) ``` Parameters isTracked: Boolean Returns [TrackingStatus](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_trackingstatus) |
| --- | --- |
...
| **isTracked** : Boolean [Get][Set] | Signature ```kotlin var isTracked: Boolean ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> TrackingStatus ``` |
...
| **isTrackedData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val isTrackedData: BooleanAttributeData ``` |
| **isTrackedId** [Get] | Signature ```kotlin val isTrackedId: ``` |
