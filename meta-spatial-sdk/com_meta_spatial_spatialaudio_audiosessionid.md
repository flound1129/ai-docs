...
```kotlin
class AudioSessionId(audioSessionId: Int = 0, type: AudioType = AudioType.SOUNDFIELD) : ComponentBase
```

## Constructors

| **AudioSessionId** ( audioSessionId , type ) | Signature ```kotlin constructor(audioSessionId: Int = 0, type: AudioType = AudioType.SOUNDFIELD) ``` Parameters audioSessionId: Int type: [AudioType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_audiotype) Returns [AudioSessionId](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_audiosessionid) |
| --- | --- |

## Properties

| **audioSessionId** : Int [Get][Set] | Signature ```kotlin var audioSessionId: Int ``` |
| --- | --- |
...
| **type** : [AudioType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_audiotype) [Get][Set] | Signature ```kotlin var type: AudioType ``` |
...
| **audioSessionIdData** : [IntAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_intattributedata) [Get] | Signature ```kotlin val audioSessionIdData: IntAttributeData ``` |
| **audioSessionIdId** [Get] | Signature ```kotlin val audioSessionIdId: ``` |
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> AudioSessionId ``` |
