...
```kotlin
class SpatialAudioFeature : SpatialFeature
```

## Constructors

| **SpatialAudioFeature** () | Signature ```kotlin constructor() ``` Returns [SpatialAudioFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_spatialaudio_spatialaudiofeature) |
| --- | --- |
