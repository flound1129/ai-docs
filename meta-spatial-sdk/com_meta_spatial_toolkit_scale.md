...
Sets the scale for any [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) with a [SceneObject](/reference/spatial-sdk/v0.10.1/com_meta_spatial_runtime_sceneobject) attached. [SceneObject](/reference/spatial-sdk/v0.10.1/com_meta_spatial_runtime_sceneobject) s can be attached with the [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) and [Panel](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_panel) components.

The Scale component applies uniform scaling in the X, Y, and Z directions as a percentage of the original size. Example:

```kotlin myEntity.setComponent(Scale(Vector3(1f, 2f, 1f))) // doubles the height of the SceneObject. ```

Note: Does NOT scale any transforms or children
...
| **Scale** ( scale ) | Signature ```kotlin constructor(scale: Vector3 = Vector3(1.0f, 1.0f, 1.0f)) ``` Parameters scale: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) The Vector3 scale to apply in the X, Y, and Z directions. Returns [Scale](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_scale) |
| --- | --- |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Scale ``` |
...
| **scaleData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val scaleData: Vector3AttributeData ``` |
| **scaleId** [Get] | Signature ```kotlin val scaleId: ``` |
