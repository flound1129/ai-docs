...
| **PanelDimensions** ( dimensions ) | Signature ```kotlin constructor(dimensions: Vector2 = Vector2(0.75f, 1.0f)) ``` Parameters dimensions: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) Returns [PanelDimensions](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_paneldimensions) |
| --- | --- |
...
| --- | --- |
| **dimensions** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | The dimensions (width, height) of the panel in meters. Signature ```kotlin var dimensions: Vector2 ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> PanelDimensions ``` |
