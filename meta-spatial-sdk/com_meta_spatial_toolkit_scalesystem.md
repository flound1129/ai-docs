...
This System comes default with Meta Spatial SDK and operates on entities with [Scale](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_scale) components. It applies scaling to [SceneObject](/reference/spatial-sdk/v0.10.1/com_meta_spatial_runtime_sceneobject) s when the [Scale](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_scale) , [Mesh](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_mesh) , or [Panel](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_panel) components change.
...
| **ScaleSystem** () | Signature ```kotlin constructor() ``` Returns [ScaleSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_scalesystem) |
| --- | --- |
