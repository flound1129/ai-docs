...
IsdkPanelDimensions represents the dimensions on a panel in ISDK. This component is auto-created by IsdkSystem. The panel's height and width will be the values from PanelRegistration or the PanelDimensions component.

## Signature

```kotlin
class IsdkPanelDimensions(dimensions: Vector2 = Vector2(0.75f, 1.0f), localOffset: Vector2 = Vector2(0.0f, 0.0f)) : ComponentBase
```

## Constructors

| **IsdkPanelDimensions** ( dimensions , localOffset ) | Signature ```kotlin constructor(dimensions: Vector2 = Vector2(0.75f, 1.0f), localOffset: Vector2 = Vector2(0.0f, 0.0f)) ``` Parameters dimensions: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) The dimensions of the panel. localOffset: [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) Returns [IsdkPanelDimensions](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkpaneldimensions) |
| --- | --- |
...
| --- | --- |
| **dimensions** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | The dimensions of the panel. Signature ```kotlin var dimensions: Vector2 ``` |
| **entID** : Long [Get][Set] | Signature ```kotlin var entID: Long ``` |
| **isDirty** : Boolean [Get][Set] | Signature ```kotlin var isDirty: Boolean ``` |
| **localOffset** : [Vector2](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2) [Get][Set] | Signature ```kotlin var localOffset: Vector2 ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> IsdkPanelDimensions ``` |
| **dimensionsData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val dimensionsData: Vector2AttributeData ``` |
...
| **localOffsetData** : [Vector2AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector2attributedata) [Get] | Signature ```kotlin val localOffsetData: Vector2AttributeData ``` |
| **localOffsetId** [Get] | Signature ```kotlin val localOffsetId: ``` |
