...
```kotlin
class MRUKVolume(min: Vector3 = Vector3(0.0f, 0.0f, 0.0f), max: Vector3 = Vector3(0.0f, 0.0f, 0.0f)) : ComponentBase
```

## Constructors

| **MRUKVolume** ( min , max ) | Signature ```kotlin constructor(min: Vector3 = Vector3(0.0f, 0.0f, 0.0f), max: Vector3 = Vector3(0.0f, 0.0f, 0.0f)) ``` Parameters min: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) max: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) Returns [MRUKVolume](/reference/spatial-sdk/v0.10.1/com_meta_spatial_mruk_mrukvolume) |
| --- | --- |
...
| --- | --- |
| **getCenter** () | Signature ```kotlin fun MRUKVolume.getCenter(): Vector3 ``` Returns [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) |
...
| **getSize** () | Signature ```kotlin fun MRUKVolume.getSize(): Vector3 ``` Returns [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) |
| **getVolume** () | Signature ```kotlin fun MRUKVolume.getVolume(): Float ``` Returns Float |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> MRUKVolume ``` |
