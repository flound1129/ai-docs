# IsdkGrabbableFollowableSystem Class
...
```kotlin
class IsdkGrabbableFollowableSystem : SystemBase
```

## Constructors

| **IsdkGrabbableFollowableSystem** () | Signature ```kotlin constructor() ``` Returns [IsdkGrabbableFollowableSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkgrabbablefollowablesystem) |
| --- | --- |
