...
```kotlin
class PanelScaleInAnimation(initialScale: Vector3 = Vector3(0.01f, 0.01f, 0.01f), startTime: Long = 0, durationInMs: Long = 500) : ComponentBase
```

## Constructors

| **PanelScaleInAnimation** ( initialScale , startTime , durationInMs ) | Signature ```kotlin constructor(initialScale: Vector3 = Vector3(0.01f, 0.01f, 0.01f), startTime: Long = 0, durationInMs: Long = 500) ``` Parameters initialScale: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) startTime: Long durationInMs: Long Returns [PanelScaleInAnimation](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelscaleinanimation) |
| --- | --- |
...
| **initialScale** : [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) [Get][Set] | Signature ```kotlin var initialScale: Vector3 ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> PanelScaleInAnimation ``` |
...
| **initialScaleData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val initialScaleData: Vector3AttributeData ``` |
| **initialScaleId** [Get] | Signature ```kotlin val initialScaleId: ``` |
