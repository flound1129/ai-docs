...
| **Visible** ( isVisible ) | Signature ```kotlin constructor(isVisible: Boolean = true) ``` Parameters isVisible: Boolean The mesh's current visibility state. Returns [Visible](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_visible) |
| --- | --- |
...
| **isVisible** : Boolean [Get][Set] | The mesh's current visibility state. Signature ```kotlin var isVisible: Boolean ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> Visible ``` |
...
| **isVisibleData** : [BooleanAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_booleanattributedata) [Get] | Signature ```kotlin val isVisibleData: BooleanAttributeData ``` |
| **isVisibleId** [Get] | Signature ```kotlin val isVisibleId: ``` |
