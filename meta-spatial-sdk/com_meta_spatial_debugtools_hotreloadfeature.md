...
```kotlin
class HotReloadFeature(val activity: AppSystemActivity) : SpatialFeature
```

## Constructors

| **HotReloadFeature** ( activity ) | Signature ```kotlin constructor(activity: AppSystemActivity) ``` Parameters activity: [AppSystemActivity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_appsystemactivity) Returns [HotReloadFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_debugtools_hotreloadfeature) |
| --- | --- |
...
| --- | --- |
| **featureCheckReceiver** : Any [Get] | Signature ```kotlin val featureCheckReceiver: Any ``` |
| **reloadReceiver** : Any [Get] | Signature ```kotlin val reloadReceiver: Any ``` |
