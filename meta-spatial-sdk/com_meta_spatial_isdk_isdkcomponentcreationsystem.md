# IsdkComponentCreationSystem Class
...
```kotlin
class IsdkComponentCreationSystem : SystemBase
```

## Constructors

| **IsdkComponentCreationSystem** () | Signature ```kotlin constructor() ``` Returns [IsdkComponentCreationSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkcomponentcreationsystem) |
| --- | --- |
