...
IsdkBoxCollider provides a box for collision detection in ISDK interactions.

## Signature

```kotlin
class IsdkBoxCollider(size: Vector3 = Vector3(0.1f, 0.1f, 0.1f), offset: Vector3 = Vector3(0.0f, 0.0f, 0.0f)) : ComponentBase
```

## Constructors

| **IsdkBoxCollider** ( size , offset ) | Signature ```kotlin constructor(size: Vector3 = Vector3(0.1f, 0.1f, 0.1f), offset: Vector3 = Vector3(0.0f, 0.0f, 0.0f)) ``` Parameters size: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) of the box collider offset: [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) Returns [IsdkBoxCollider](/reference/spatial-sdk/v0.10.1/com_meta_spatial_isdk_isdkboxcollider) |
| --- | --- |
...
| **offset** : [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) [Get][Set] | offset to shift the position of the collider Signature ```kotlin var offset: Vector3 ``` |
| **recycled** : Boolean [Get][Set] | Signature ```kotlin var recycled: Boolean ``` |
| **size** : [Vector3](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3) [Get][Set] | size of the box collider Signature ```kotlin var size: Vector3 ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> IsdkBoxCollider ``` |
...
| **offsetData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val offsetData: Vector3AttributeData ``` |
| **offsetId** [Get] | Signature ```kotlin val offsetId: ``` |
| **sizeData** : [Vector3AttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_vector3attributedata) [Get] | Signature ```kotlin val sizeData: Vector3AttributeData ``` |
| **sizeId** [Get] | Signature ```kotlin val sizeId: ``` |
