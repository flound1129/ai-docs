...
| **OVRMetricsFeature** ( context , groups ) | Signature ```kotlin constructor(context: Context, vararg groups: OVRMetricsGroup) ``` Parameters context: Context groups: [OVRMetricsGroup](/reference/spatial-sdk/v0.10.1/com_meta_spatial_ovrmetrics_ovrmetricsgroup) Returns [OVRMetricsFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_ovrmetrics_ovrmetricsfeature) |
| --- | --- |
