...
| **TransformParent** ( entity ) | Signature ```kotlin constructor(entity: Entity = Entity.nullEntity()) ``` Parameters entity: [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) The parent entity. Returns [TransformParent](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_transformparent) |
| --- | --- |
...
| **entity** : [Entity](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entity) [Get][Set] | The entity that this component is attached to. Signature ```kotlin var entity: Entity ``` |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> TransformParent ``` |
| **entityData** : [EntityAttributeData](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_entityattributedata) [Get] | Signature ```kotlin val entityData: EntityAttributeData ``` |
| **entityId** [Get] | Signature ```kotlin val entityId: ``` |
