...
```kotlin
class PanelScaleOutAnimation(startTime: Long = 0, durationInMs: Long = 500) : ComponentBase
```

## Constructors

| **PanelScaleOutAnimation** ( startTime , durationInMs ) | Signature ```kotlin constructor(startTime: Long = 0, durationInMs: Long = 500) ``` Parameters startTime: Long durationInMs: Long Returns [PanelScaleOutAnimation](/reference/spatial-sdk/v0.10.1/com_meta_spatial_animation_panelscaleoutanimation) |
| --- | --- |
...
| **createDefaultInstance** : Function0 [Get] | Signature ```kotlin open override val createDefaultInstance: () -> PanelScaleOutAnimation ``` |
