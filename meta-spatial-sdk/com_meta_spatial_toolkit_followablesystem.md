...
This system comes default with Meta Spatial SDK and operates on entities with [Followable](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_followable) and [Transform](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_transform) components. It allows objects to automatically follow and orient themselves toward target entities, with configurable offset, rotation type, and speed parameters.

It also respects parent-child relationships through [TransformParent](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_transformparent) components and can be temporarily disabled during interactions with [Grabbable](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_grabbable) .
...
| **FollowableSystem** () | Signature ```kotlin constructor() ``` Returns [FollowableSystem](/reference/spatial-sdk/v0.10.1/com_meta_spatial_toolkit_followablesystem) |
| --- | --- |
