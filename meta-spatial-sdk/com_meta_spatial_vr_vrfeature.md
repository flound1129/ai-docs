...
| **VRFeature** ( ctx , locomotionSystemControlsChoice , shouldConsumeLeftRightInput , inputSystemType ) | Signature ```kotlin constructor(ctx: Context, locomotionSystemControlsChoice: LocomotionControls = LocomotionControls.Right, shouldConsumeLeftRightInput: Boolean = true, inputSystemType: VrInputSystemType = VrInputSystemType.INTERACTION_SDK) ``` Parameters ctx: Context locomotionSystemControlsChoice: [LocomotionControls](/reference/spatial-sdk/v0.10.1/com_meta_spatial_vr_locomotioncontrols) shouldConsumeLeftRightInput: Boolean inputSystemType: [VrInputSystemType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_vr_vrinputsystemtype) Returns [VRFeature](/reference/spatial-sdk/v0.10.1/com_meta_spatial_vr_vrfeature) |
| --- | --- |
...
| --- | --- |
| **inputSystemType** : [VrInputSystemType](/reference/spatial-sdk/v0.10.1/com_meta_spatial_vr_vrinputsystemtype) [Get] | Signature ```kotlin val inputSystemType: VrInputSystemType ``` |
| **locomotionSystemControlsChoice** : [LocomotionControls](/reference/spatial-sdk/v0.10.1/com_meta_spatial_vr_locomotioncontrols) [Get] | Signature ```kotlin val locomotionSystemControlsChoice: LocomotionControls ``` |
| **shouldConsumeLeftRightInput** : Boolean [Get] | Signature ```kotlin val shouldConsumeLeftRightInput: Boolean = true ``` |
...
| --- | --- |
| **earlySystemsToRegister** () | Override this method to register your systems that should be executed with [PriorityGroup](/reference/spatial-sdk/v0.10.1/com_meta_spatial_core_prioritygroup) EARLY. Signature ```kotlin open override fun earlySystemsToRegister(): List<SystemBase> ``` Returns List A list of SystemBase objects |
...
| **preRuntimeOnCreate** ( savedInstanceState ) | Called before the application's onCreate() method is called. Override this method to perform actions before the rest of the OnCreate() lifecycle of the application. Signature ```kotlin open override fun preRuntimeOnCreate(savedInstanceState: Bundle?) ``` Parameters savedInstanceState: Bundle? The saved instance state of the application. |
